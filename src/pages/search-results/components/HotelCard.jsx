        ...
        <div className="bg-card border border-border rounded-lg overflow-hidden shadow-brand-sm hover-lift transition-brand">
          ...
          <div className="p-4">
            <div className="flex items-start justify-between mb-2">
              <div>
                <h3 className="font-semibold text-foreground group-hover:text-primary transition-brand line-clamp-1">
                  {hotel?.name}
                </h3>
              ...
              <div className={`px-2 py-1 rounded text-xs font-medium ${getRatingColor(hotel?.guestRating)}`}>
                {hotel?.guestRating}
              </div>
            </div>
