...
const Wishlist = () => {
  const [wishlistItems, setWishlistItems] = useState([
  {
    ...
    reviewCount: 2847,
    priceFrom: "$450",
    image: "https://images.unsplash.com/photo-1585441167263-b2f5aa748adf",
    imageAlt: "Luxury hotel exterior with classic architecture and elegant entrance",
  ...
  {
    id: 2,
    hotelName: "Santorini Blue Domes",
    location: "Santorini, Greece",
    rating: 4.9,
    reviewCount: 1523,
    priceFrom: "$320",
    image: "https://images.unsplash.com/photo-1637170473768-c883efa37af9",
    imageAlt: "Traditional white and blue Greek architecture overlooking the Aegean Sea",
  ...
  {
    id: 3,
    hotelName: "Tokyo Sky Tower Hotel",
    location: "Tokyo, Japan",
    rating: 4.7,
    reviewCount: 3421,
    priceFrom: "$280",
    image: "https://images.unsplash.com/photo-1604503816506-b20032dabf9a",
    imageAlt: "Modern skyscraper hotel with glass facade against Tokyo city skyline",
    amenities: ["City View", "Gym", "Business Center", "Restaurant"],
    addedDate: "2025-10-05",
    isAvailable: false
  },
  {
    id: 4,
    hotelName: "Swiss Alpine Resort",
    location: "Zermatt, Switzerland",
    rating: 4.6,
    reviewCount: 987,
    priceFrom: "$520",
    image: "https://images.unsplash.com/photo-1628582786822-a5763dc8b2ca",
    imageAlt: "Cozy mountain resort with wooden chalet architecture surrounded by snow-capped Alps",
